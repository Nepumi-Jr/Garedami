...
def JudgeRun(problemInfo: Problem, proLang: str, srcPath: str, problemDir: str, timeLimit: int, memoryLimit: int):
    ...
    try:
        ...
        printLog(
            "Judge : "+f"""{problemInfo.judgingRun.main} {problemInfo.judgingRun.args}""")
        printLog(
            "Compr : "+f"""{problemInfo.compareRun.main} {problemInfo.compareRun.args}""")
        printLog(
            "runni : "+f"""{problemInfo.running[proLang].main} {problemInfo.running[proLang].args}""")
